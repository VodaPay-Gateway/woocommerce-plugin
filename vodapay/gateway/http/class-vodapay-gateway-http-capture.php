...
/**
 * VodaPayGatewayHttpCapture class.
 */

use Ngenius\NgeniusCommon\Formatter\ValueFormatter;

class VodaPayGatewayHttpCapture extends VodaPayGatewayHttpAbstract
{
    public function get_total_amount($response): int
    {
        $amount     = 0;
        $embedded   = self::VODAPAY_EMBEDED;
        $cnpCapture = self::VODAPAY_CAPTURE;
