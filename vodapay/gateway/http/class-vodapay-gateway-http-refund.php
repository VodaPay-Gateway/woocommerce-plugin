...
/**
 * VodaPayGatewayHttpRefund class.
 */
class VodaPayGatewayHttpRefund extends VodaPayGatewayHttpAbstract
{
    public function get_refunded_amount($response): array
    {
        ...
        $refund_stmt     = self::VODAPAY_REFUND;
    ...
    {
        $cupResults = self::VODAPAY_CUP_RESULTS;
